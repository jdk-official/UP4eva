// Batch update 2026-07-13 (c): royaluus + Karrol — full T1/T2/T3.
// Both: T1 Tank, T2 Air, T3 Missile.
...
const FIXES = {
  royaluus: { squad1: 44950000, squadType: 'Tank', squad2: 32520000, squad2Type: 'Air', squad3: 30830000, squad3Type: 'Missile', squadGroup: true },
  karrol:   { squad1: 38320000, squadType: 'Tank', squad2: 28410000, squad2Type: 'Air', squad3: 26490000, squad3Type: 'Missile', squadGroup: true }
};
...
(async () => {
  ...
  Object.keys(FIXES).forEach(k => {
    ...
    console.log(v.name + ': s1=' + v.squad1 / 1e6 + 'M ' + v.squadType +
      ' s2=' + v.squad2 / 1e6 + 'M ' + v.squad2Type +
      ' s3=' + v.squad3 / 1e6 + 'M ' + v.squad3Type + ' flag=' + !!v.squadGroup);
  });
  console.log('squad1 count: ' + beforeSquad + ' -> ' + vroster.filter(m => m.squad1 != null).length +
